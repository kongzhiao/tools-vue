export default (initialState: {
  ...
  return {
    ...
    canAccessRefundRecords: hasModulePermission('应补应退明细'),
    canReadRefundRecords: hasPermission('应补应退明细:查看'),
    canImportRefundRecords: hasPermission('应补应退明细:导入'),
    canWashRefundRecords: hasPermission('应补应退明细:清洗'),
    canExportRefundRecords: hasPermission('应补应退明细:导出'),
    canAccessNoticeRecords: hasModulePermission('下放通知'),
    canReadNoticeRecords: hasPermission('下放通知:查看'),
    canImportNoticeRecords: hasPermission('下放通知:导入'),
    canDistributeNoticeRecords: hasPermission('下放通知:下放'),
    canFeedbackNoticeRecords: hasPermission('下放通知:回填'),
    canMarkNoticeReimbursement: hasPermission('下放通知:报销标记'),
    canRemarkNoticeRecords: hasPermission('下放通知:备注'),
    canExportNoticeRecords: hasPermission('下放通知:导出'),
    ...
    canDispatchEnrollLedgers: hasPermission('参保台账明细:下放'),
    canRecallEnrollLedgers: hasPermission('参保台账明细:收回'),
    canReadEnrollReviewBatches: hasPermission('参保台账明细:下放批次'),
